...
Required fields: id, name, email, role, company, **register**, **one verbatim substrate snippet** (a sentence from their bio / blog / talk / job post that makes them them, not a generic role-holder).
...
- **Em-dash hygiene.** If the prospect's verbatim quote contains em-dashes (—), that's fine: it's their voice. But your own annotations (`why-this-prospect`, etc.) should use periods, commas, or parens. Em-dashes from your annotations don't enter drafts, but readability improves.
